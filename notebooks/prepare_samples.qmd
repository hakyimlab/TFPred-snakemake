...
yaml::write_yaml(enlist[1:10], file = '/project2/haky/temi/projects/TFPred-snakemake/metadata/enpact_models_to_train.short.yaml')
```

```{r}
names(rapply(peakslist, function(x) head(x, 1)))
```
